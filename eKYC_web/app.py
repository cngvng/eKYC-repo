...
app = Flask(__name__)
app.config["IMAGE_UPLOADS"] = r"/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads"
...
def upload_image():
    ...
    if request.method == "POST":
        if request.files:
            ...
            dirname=dirname.replace('-','')
            dirname=dirname.replace(' ','')
            newpath = r'/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads/images/'+str(dirname) +'dataset'
...
def formImg(fileName,dirname):
    ...
    for i in range(0, counter):
        ...
        imagePath = r"/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads/\p" + \
            str(i)+".png"
        ...
        for (x, y, w, h) in faces:
            ...
            if(count==0):
                cv2.imwrite(f'/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads/images/{dirname}dataset/face.jpg', roi_color)
                count=count+1
...
def camera():
    ...
    while( i < 200): 
        ...
        i=i+1
        if i==101:
            cv2.imwrite(f'/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads/images/{dirname}\\dataset\\trial{str(i)}.jpeg',frame)
...
def compare(dirname):
    ...
    target=f'/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads/images/{dirname}dataset/trial101.jpeg'
    directory=f'/Users/cngvng/Desktop/code/eKYC/E-KYC/uploads/images/{dirname}dataset/face.jpg'
